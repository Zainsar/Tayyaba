...
$fetch_cat = "SELECT * FROM `addcat` WHERE status = '1'";
                        ...
                        <div class="col-12">
                            <div class="bg-secondary rounded h-100 p-4">
                                <div class="page-title-inner">
                                    <h3 class="mb-4 text-primary">View Catrgories</h3>
                                        ...
                                        <tbody>
                                            ...
                                            while ($show = mysqli_fetch_assoc($cat_query)) {
                                                ...
                                                <tr>
                                                    ...
                                                    ?>
                                                    <td><a href="updatecat.php?id=<?php echo $show['id']; ?>"
                                                            class="btn btn-warning">Update</a>
                                                        <a href="trashcat.php?id=<?php echo $show['id']; ?>"
